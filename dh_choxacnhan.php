...
<?php 
 ...
 <?php
	if(isset($_GET['confirmid'])){
     	...
     	$shifted_confirm = $ct->shifted_confirm1($id,$time);
    }
?>
<?php
    // gọi class category
 ...
 <div class="main">
    <div class="content">
    	<div style=" background: #f0f8fc; height: 50px;">
    		<br>
				...
				<div style="background:#f0f8fc; ">
						...
						<table class="table">
							...
							<tr>
								...
								<td></td>
								<td>
								 	<a class="btn btn-warning" href="?confirmid=<?php echo $customer_id ?>&time=<?php echo $result['date_order'] ?>">Hủy đơn</a>
