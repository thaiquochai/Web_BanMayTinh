...
<body>
  <div class="wrap">
		<div class="header_top">
			...
			<div class="logo">
				<a href="index.php"><img src="images/logo.png" alt="" height="150px" width=250px /></a>
			</div>
			<div class="floatleft middle" >
					<h1 style="text-shadow: 5px 10px #870909; float: left; margin-left: 22px;margin-top: -14px; color:#ddd;margin:0">DichVuSHOP</h1>
					<p style="color: #ddd; margin: 0;font-weight: bold; float: left;">www.dichvushop.com</p>
			</div>
