  ...
  <footer id="dk-footer" class="dk-footer">
        <div class="container">
            <div class="row">   
            		 <div class="footer-social-link" style="font-size: 30px;">
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/thaiquochai1903/">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="footer-widget">
                               ...
                               Trang web những mặt hàng dịch vụ tốt nhất!</p>
                               <?php
                                ...
                                <form action="#" method="post">
                                    <div class="form-row">
                                        <div class="col dk-footer-form">
                                            <input type="text" class="form-control" placeholder="Email Address" name="email" style="border-radius:30px; height:40px;" >
                ...
                <script>
                  var map = L.map('map').setView([10.371570034409267, 105.43232215989568], 14);
               ...
               <div style="font-size: 15px; color: white;">DichVu Shop <a href="https://www.google.com/maps/place/10%C2%B022'32.1%22N+105%C2%B025'05.8%22E/@10.278967,105.3495952,21z/data=!4m5!3m4!1s0x0:0xdcdd62777adf5401!8m2!3d10.37557!4d105.41829">Xem đường đi</a></div>
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <span>Copyright © 2022, Hải & Huyền</span>
                    </div>
                    <!-- End Col -->
                    <div class="col-md-6">
