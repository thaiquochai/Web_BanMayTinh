...
<?php 
 ...
 <?php
	if(isset($_GET['confirmid'])){
     	...
     	$shifted_confirm = $ct->shifted_confirm2($id,$time);
    }
?>
<?php
    // gọi class category
			...
			<div class="cartpage">
				...
				<div style="background:#f0f8fc; ">
						...
						<table class="table">
							...
							<?php
							$customer_id = Session::get('customer_id');  
							$get_cart_ordered = $ct->get_cart_ordered3($customer_id);
							...
							if($get_cart_ordered){
							 ...
							 ?>
								...
								<?php
									...
									$demslsp=$ct->dem_get_cart_ordered3($customer_id, $date);
							...
							<tr>
								...
								<td></td>
								<td>
								 	<a class="btn btn-warning" href="?confirmid=<?php echo $customer_id ?>&time=<?php echo $result['date_order'] ?>">Mua lại</a>

								 	<a class="btn btn-warning" href="chitietdonhang.php?date_order=<?php echo $result['date_order'] ?>">Chi tiết đơn hàng</a>
