    		...
    		if ($get_product_details) {
    		 ...
    		 ?>
				...
				<div class="desc span_3_of_2" >
					...
					<div><b style="font-size: 13px;">Tên cửa hàng : <span > <?php echo $result_details['tencuahang'] ?></span></b></div>
					<div><a href="cuahang.php?idcuahang=<?php echo $result_details['id_cuahang'] ?>">Xem cửa hàng</a></div>		
					<div class="price" >
