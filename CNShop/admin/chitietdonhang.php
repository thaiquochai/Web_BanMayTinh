                ...
                if (isset($del_shifted)) {
                 ...
                 ?>         
					...
					<tbody>
						...
						$ct = new cart();
						$fm = new Format();
						$get_inbox_cart = $ct -> donhangchitiet($date_order,$customer_id);
						if ($get_inbox_cart) {
							$i=0;
						...
						<tr class="odd gradeX">
							...
							<td>
								...
								<a href="?delid=<?php echo $result['id'] ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['date_order'] ?>">Xóa đơn</a>
								 ...
								 ?>
								 		<a href="?delid=<?php echo $result['id'] ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['date_order'] ?>">Đơn hàng này đã hủy</a>
								<?php }?>
							</td>
						</tr>
						<?php 
