                ...
                <tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            <option>Chọn</option>
                            <option value="1">Không nổi bậ</option>
                 ...
                 <tr>
                    ...
                    <td>
                        <select id="select" name="cuahang">
                            <option>Chọn cửa hàng</option>
                            <?php 
                            $cat = new cuahang();
                            $catlist = $cat->show_cuahang();
                            if($catlist){
                                while ($result = $catlist->fetch_assoc()){
                            
                             ?>
                            <option value=" <?php echo $result['id'] ?> "> <?php echo $result['tencuahang'] ?> </option>
